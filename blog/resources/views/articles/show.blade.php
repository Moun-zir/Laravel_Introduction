...
@section('content')
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mt-6">
            ...
            <p class="text-gray-700 text-lg mb-4 font-serif text-sm">{{ $article->body }}</p>
        ...
        <div class="bg-gray-50 shadow-md rounded-lg p-6 mt-6">
            <h2 class="text-xl font-bold text-gray-800 mb-4 font-serif text-2xl">Les commentaires de l'article :</h2>

            @forelse($article->comments as $comment)
                <div class="border-b border-gray-200 pb-4 mb-4">
                    <p class="text-sm text-gray-600">
                        <strong class="text-blue-500 font-serif text-sm">{{ $comment->user->name }}</strong> a réagi :
                    </p>
                    <p class="text-gray-700 font-serif text-sm">{{ $comment->comment }}</p>
